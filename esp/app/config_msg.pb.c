...
const pb_field_t DisplaySettings_fields[3] = {
    PB_FIELD(  1, BOOL    , REQUIRED, STATIC  , FIRST, DisplaySettings, enabled, enabled, &DisplaySettings_enabled_default),
    PB_FIELD(  2, UINT32  , REQUIRED, STATIC  , OTHER, DisplaySettings, I2Cspeed, enabled, &DisplaySettings_I2Cspeed_default),
    PB_LAST_FIELD
};
...
const pb_field_t MQTT_fields[5] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC  , FIRST, MQTT, host, host, &MQTT_host_default),
    PB_FIELD(  2, UINT32  , REQUIRED, STATIC  , OTHER, MQTT, port, host, &MQTT_port_default),
    PB_FIELD(  3, STRING  , REQUIRED, STATIC  , OTHER, MQTT, username, port, &MQTT_username_default),
